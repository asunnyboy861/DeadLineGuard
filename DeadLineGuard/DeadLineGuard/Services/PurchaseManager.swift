...
enum ProductID {
    static let monthly = "com.zzoutuo.DeadLineGuard.pro.monthly"
    static let yearly = "com.zzoutuo.DeadLineGuard.pro.yearly"
    static let lifetime = "com.zzoutuo.DeadLineGuard.pro.lifetime"
